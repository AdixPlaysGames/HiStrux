...
HiStrux's **reConstruct** module enables the enrichment of results by incorporating an additional variable: the assignment vector to interphase stages. By extracting data using the **eXtract** module, you can create various models, including classifiers for interphase stages. **CycleSort** is one such proposal.
